...
Jamie helpfully created a checklist of steps for running EEG participants that can be found [here](https://bcvl.github.io/onboarding/EEG.html).  
...
library(knitr)
library(kableExtra)
data <- read.csv(file='thesisRubric.csv',header = TRUE, sep = ',')
kable(data) %>%
